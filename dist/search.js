...
var songs = document.querySelector('.songlist');
...
searchname.innerHTML = "\u641C\u7D22\uFF1A".concat(searchvalue);
...
var _loop = function _loop(i) {
  ...
  var id = res[i].id;
  var src1 = res[i].album.artist.img1v1Url;
  ...
  if (code == 13) {
    fetch("http://redrock.udday.cn:2022/search?keywords=".concat(searchbox.value), {
      ...
      var _loop2 = function _loop2(_i) {
        ...
        songer1.setAttribute('class', 'songer2');
        cd.setAttribute('class', 'cd');
        names.push(res[_i].album.name);
        console.log(names);
        ids.push(res[_i].id);
        buttonpic.push(res[_i].album.artist.img1v1Url);
        songerlist.push(res[_i].artists[0].name);
        ...
        name.innerHTML = res[_i].name;
        songer1.innerHTML = res[_i].artists[0].name;
        ...
        li.appendChild(songer1);
        var id = res[_i].id;
        var src1 = res[_i].album.artist.img1v1Url;

        li['onclick'] = function (x) {
          buttonimg.src = src1;
          songer2.innerHTML = res[_i].artists[0].name;
          song1.innerHTML = res[_i].name;
          fetch("http://redrock.udday.cn:2022/song/url?id=".concat(id)).then(function (res) {
            return res.json();
          }).then(function (res) {
            Audio.src = res.data[0].url;
