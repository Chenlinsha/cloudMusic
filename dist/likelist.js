...
var atouxiang = document.querySelector('.atouxiang');
...
fetch("http://redrock.udday.cn:2022/likelist?uid=".concat(userid, "&cookie=").concat(cookie)).then(function (res) {
  return res.json();
}).then(function (res) {
  ids = res.ids;

  var _loop = function _loop(i) {
    fetch("http://redrock.udday.cn:2022/song/detail?ids=".concat(ids[i])).then(function (res) {
      return res.json();
    }).then(function (res) {
      var ul = document.querySelector('.songs1');
      ...
      var _loop2 = function _loop2(j) {
        ...
        var piclove = localStorage.getItem("piclove");
        var id = res.songs[j].id;
...
Audio.addEventListener('timeupdate', function (e) {
  ...
  contorlDot.style.left = "".concat(value * 100, "%");
});
...
/******/ 	(() => {
/******/ 		__webpack_require__.hmrF = () => ("likelist." + __webpack_require__.h() + ".hot-update.json");
/******/ 	})();
/******/ 	
